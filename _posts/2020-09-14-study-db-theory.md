...
> 정보 시스템에서 가장 중요한 요소 : 정보
 ...
 ## 데이터베이스 란?(통·운·의·공·저)
 - 정의 - 통합, 운영, 의사결정, 공유, 저장   
 - **정의풀어쓰기)**서로 연관된 정보의 중복을 최소화하여 한 곳에 모아 저장함으로써 다수의 사용자로 하여금 운영 및 전략 수집에 필요한 정보를 효과적으로 공유하도록 한 정보의 집합체
   
   

## 파일 시스템의 문제점(개·무·동·핵·이)
 - 업무별 분석시스템 개발
 - 무결성, 데이터불일치
 - 동시성제어
 - 핵심정보유출
...
## 데이터베이스 시스템의 개념 단계(Conceptual level)
- 정의 - 전체 조직이나 데이터베이스 관리자가 보는 통합관점에서의 데이터베이스의 논리적 구조
...
## 데이터베이스 시스템의 내부 단계(Internal level)
 - 정의 
	- 실제로 데이터가 저장된 방삭의 표현
 - 내부 스키마(Internal schema)
	- 내부레코드의 물리적 순서, 인덱스의 유/무, 파티셔닝
	- 기술내용에 따라 OS파일시스템에 의하여 물리적저장장치에 저장됨
...
3) 데이터 제어어 (DCL : Data Control Language)
 ...
 - 주로 정보 관리 목적으로 데이터베이스 관리자에 의해 사용

 

## 데이터베이스 사용자의 역할에 따른 분류
 - 응용 프로그래머 - 프로그래밍 언어를 이용하여 조직의 응용 프로그램을 작성
 - 데이터베이스 설계자 - 실 세계 응용 분야의 업무를 분석하여 논리적, 물리적 데이터 구조로 형식화하여 정의
 - 일반 사용자 : 
	- 조직 업무를 위해 데이터베이스 정보를 조작하는 최종 사용자
	- 응용 프로그램을 통해 접근 or 질의 편집 도구를 이용하여 접근
 - 데이터베이스 관리자 - 데이터베이스의 사용과 유지에 대하여 전반적인 관리와 책임
...
## 데이터베이스 관리자(DBA : Database Administrator)
 ...
 - 역할 : 
	...
	|---|---|
	|분석|스키마의 정의와 수정|
	|설계|데이터 저장구조와 접근 방법의 정의|
	|설계|무결성 제약조건을 지정|
	|구현|사용자에게 데이터 접근 권한을 부여|
	|유지보수|백업과 복구를 위한 정책 결정|
	|유지보수|가용성 유지|